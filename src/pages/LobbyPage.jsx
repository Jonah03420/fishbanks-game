...
function OceanBg({ children, wide = false }) {
  return (
    <div className="w-full h-full bg-gradient-to-br from-blue-800 to-blue-950 text-white flex items-center justify-center overflow-hidden relative">
      ...
      {/* Bubbles */}
      <div className="absolute bottom-24 left-24 w-2.5 h-2.5 bg-cyan-300/40 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-6s'}}/>
      <div className="absolute bottom-40 left-52 w-3.5 h-3.5 bg-blue-300/30 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-4.2s'}}/>
      <div className="absolute bottom-20 left-1/3 w-2 h-2 bg-cyan-200/40 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-2.1s'}}/>
      <div className="absolute bottom-32 right-48 w-4 h-4 bg-blue-400/25 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-5.4s'}}/>
      <div className="absolute bottom-16 right-28 w-2.5 h-2.5 bg-cyan-300/35 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-3.3s'}}/>
      <div className="absolute bottom-48 left-16 w-3 h-3 bg-blue-200/30 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-1.5s'}}/>
      <div className="absolute bottom-60 right-1/3 w-2 h-2 bg-sky-300/30 rounded-full bubble-float pointer-events-none" style={{animationDelay:'-0.8s'}}/>
      {/* Waves */}
